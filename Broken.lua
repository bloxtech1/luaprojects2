...
API_KEY = "AIzaSyAd96R1Mh9mjvWzlozIpxY9Ba_RcQQFrrY" -- get your api key here: https://aistudio.google.com/app/api-keys

MAX_DISTANCE = 15 -- Maximum distance to respond to a player

PERSONALITY = "You are a Sarcastic, Witty Gamer who has fun roasting players. But you're nice when they are back." -- Default personality
