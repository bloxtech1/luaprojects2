...
do
    ...
    -- Anti-Aim Section Frame for organization
    local antiAimSection = Instance.new("Frame", page)
    antiAimSection.Size = UDim2.new(0, 520, 0, 74)
    antiAimSection.Position = UDim2.new(0, 20, 0, 276)
    antiAimSection.BackgroundColor3 = Color3.fromRGB(32,32,32)
    antiAimSection.BackgroundTransparency = 0.12
    antiAimSection.BorderSizePixel = 0
    makeUICorner(antiAimSection, 8)

    local antiAimHeader = Instance.new("TextLabel", antiAimSection)
    antiAimHeader.Size = UDim2.new(1, 0, 0, 22)
    antiAimHeader.Position = UDim2.new(0, 0, 0, 0)
    antiAimHeader.BackgroundTransparency = 1
    antiAimHeader.Text = "Anti-Aim (Make it harder for aimbots to hit you)"
    antiAimHeader.TextColor3 = Color3.fromRGB(255,120,120)
    antiAimHeader.Font = Enum.Font.Code
    antiAimHeader.TextSize = 15
    antiAimHeader.TextXAlignment = Enum.TextXAlignment.Left
    antiAimHeader.TextYAlignment = Enum.TextYAlignment.Center

    local antiAimToggle = Instance.new("TextButton", antiAimSection)
    antiAimToggle.Size = UDim2.new(0, 110, 0, 24)
    antiAimToggle.Position = UDim2.new(0, 8, 0, 28)
    antiAimToggle.BackgroundColor3 = Color3.fromRGB(40,40,40)
    antiAimToggle.TextColor3 = Color3.fromRGB(255,255,255)
    antiAimToggle.Font = Enum.Font.Code
    antiAimToggle.TextSize = 14
    antiAimToggle.Text = "Anti-Aim: OFF"
    makeUICorner(antiAimToggle, 6)

    local antiModeLabel = Instance.new("TextLabel", antiAimSection)
    antiModeLabel.Size = UDim2.new(0, 80, 0, 22)
    antiModeLabel.Position = UDim2.new(0, 128, 0, 28)
    antiModeLabel.BackgroundTransparency = 1
    antiModeLabel.Text = "Mode:"
    antiModeLabel.TextColor3 = Color3.fromRGB(255,180,180)
    antiModeLabel.Font = Enum.Font.Code
    antiModeLabel.TextSize = 13
    antiModeLabel.TextXAlignment = Enum.TextXAlignment.Left
    antiModeLabel.TextYAlignment = Enum.TextYAlignment.Center

    local antiModeDropdown = Instance.new("TextButton", antiAimSection)
    antiModeDropdown.Size = UDim2.new(0, 70, 0, 22)
    antiModeDropdown.Position = UDim2.new(0, 208, 0, 28)
    antiModeDropdown.BackgroundColor3 = Color3.fromRGB(40,40,40)
    antiModeDropdown.TextColor3 = Color3.fromRGB(255,255,255)
    antiModeDropdown.Font = Enum.Font.Code
    antiModeDropdown.TextSize = 13
    antiModeDropdown.Text = "Off"
    makeUICorner(antiModeDropdown, 6)

    local yawLabel = Instance.new("TextLabel", antiAimSection)
    yawLabel.Size = UDim2.new(0, 60, 0, 22)
    yawLabel.Position = UDim2.new(0, 288, 0, 28)
    yawLabel.BackgroundTransparency = 1
    yawLabel.Text = "Yaw:"
    yawLabel.TextColor3 = Color3.fromRGB(255,180,180)
    yawLabel.Font = Enum.Font.Code
    yawLabel.TextSize = 13
    yawLabel.TextXAlignment = Enum.TextXAlignment.Left
    yawLabel.TextYAlignment = Enum.TextYAlignment.Center

    local yawBox = Instance.new("TextBox", antiAimSection)
    yawBox.Size = UDim2.new(0, 50, 0, 22)
    yawBox.Position = UDim2.new(0, 348, 0, 28)
    yawBox.BackgroundColor3 = Color3.fromRGB(40,40,40)
    yawBox.TextColor3 = Color3.fromRGB(255,255,255)
    yawBox.Font = Enum.Font.Code
    yawBox.TextSize = 13
    yawBox.Text = "180"
    makeUICorner(yawBox, 6)


    local speedLabel = Instance.new("TextLabel", antiAimSection)
    speedLabel.Size = UDim2.new(0, 60, 0, 22)
    speedLabel.Position = UDim2.new(0, 408, 0, 28)
    speedLabel.BackgroundTransparency = 1
    speedLabel.Text = "Speed:"
    speedLabel.TextColor3 = Color3.fromRGB(255,180,180)
    speedLabel.Font = Enum.Font.Code
    speedLabel.TextSize = 13
    speedLabel.TextXAlignment = Enum.TextXAlignment.Left
    speedLabel.TextYAlignment = Enum.TextYAlignment.Center

    local speedBox = Instance.new("TextBox", antiAimSection)
    speedBox.Size = UDim2.new(0, 50, 0, 22)
    speedBox.Position = UDim2.new(0, 468, 0, 28)
    speedBox.BackgroundColor3 = Color3.fromRGB(40,40,40)
    speedBox.TextColor3 = Color3.fromRGB(255,255,255)
    speedBox.Font = Enum.Font.Code
    speedBox.TextSize = 13
    speedBox.Text = "180"
    makeUICorner(speedBox, 6)

    local pitchLabel = Instance.new("TextLabel", antiAimSection)
    pitchLabel.Size = UDim2.new(0, 80, 0, 22)
    pitchLabel.Position = UDim2.new(0, 168, 0, 54)
    pitchLabel.BackgroundTransparency = 1
    pitchLabel.Text = "Pitch:"
    pitchLabel.TextColor3 = Color3.fromRGB(255,180,180)
    pitchLabel.Font = Enum.Font.Code
    pitchLabel.TextSize = 13
    pitchLabel.TextXAlignment = Enum.TextXAlignment.Left
    pitchLabel.TextYAlignment = Enum.TextYAlignment.Center

    local pitchBox = Instance.new("TextBox", antiAimSection)
    pitchBox.Size = UDim2.new(0, 50, 0, 22)
    pitchBox.Position = UDim2.new(0, 248, 0, 54)
    pitchBox.BackgroundColor3 = Color3.fromRGB(40,40,40)
    pitchBox.TextColor3 = Color3.fromRGB(255,255,255)
    pitchBox.Font = Enum.Font.Code
    pitchBox.TextSize = 13
    pitchBox.Text = "0"
    makeUICorner(pitchBox, 6)

    local jitterLabel = Instance.new("TextLabel", antiAimSection)
    jitterLabel.Size = UDim2.new(0, 80, 0, 22)
    jitterLabel.Position = UDim2.new(0, 8, 0, 54)
    jitterLabel.BackgroundTransparency = 1
    jitterLabel.Text = "Jitter Range:"
    jitterLabel.TextColor3 = Color3.fromRGB(255,180,180)
    jitterLabel.Font = Enum.Font.Code
    jitterLabel.TextSize = 13
    jitterLabel.TextXAlignment = Enum.TextXAlignment.Left
    jitterLabel.TextYAlignment = Enum.TextYAlignment.Center

    local jitterBox = Instance.new("TextBox", antiAimSection)
    jitterBox.Size = UDim2.new(0, 50, 0, 22)
    jitterBox.Position = UDim2.new(0, 98, 0, 54)
    jitterBox.BackgroundColor3 = Color3.fromRGB(40,40,40)
    jitterBox.TextColor3 = Color3.fromRGB(255,255,255)
    jitterBox.Font = Enum.Font.Code
    jitterBox.TextSize = 13
    jitterBox.Text = "30"
    makeUICorner(jitterBox, 6)

    -- Anti-aim state
    local antiaimEnabled = false
    local antiaimModes = {"Off","Spin","Jitter","Static"}
    local antiaimModeIndex = 1
    local antiaimMode = antiaimModes[antiaimModeIndex]
    local antiaimYaw = 180
    local antiaimPitch = 0
    local antiaimSpeed = 180
    local antiaimJitterRange = 30
    local antiaimCurrentYaw = antiaimYaw
    local antiaimCurrentPitch = antiaimPitch

    antiAimToggle.MouseButton1Click:Connect(function()
        antiaimEnabled = not antiaimEnabled
        antiAimToggle.Text = "Anti-Aim: " .. (antiaimEnabled and "ON" or "OFF")
    end)

    antiModeDropdown.MouseButton1Click:Connect(function()
        antiaimModeIndex = antiaimModeIndex + 1
        if antiaimModeIndex > #antiaimModes then antiaimModeIndex = 1 end
        antiaimMode = antiaimModes[antiaimModeIndex]
        antiModeDropdown.Text = antiaimMode
    end)

    yawBox.FocusLost:Connect(function()
        local v = tonumber(yawBox.Text)
        if v then antiaimYaw = v; yawBox.Text = tostring(antiaimYaw) else yawBox.Text = tostring(antiaimYaw) end
    end)
    pitchBox.FocusLost:Connect(function()
        local v = tonumber(pitchBox.Text)
        if v then antiaimPitch = v; pitchBox.Text = tostring(antiaimPitch) else pitchBox.Text = tostring(antiaimPitch) end
    end)
    speedBox.FocusLost:Connect(function()
        local v = tonumber(speedBox.Text)
        if v then antiaimSpeed = v; speedBox.Text = tostring(antiaimSpeed) else speedBox.Text = tostring(antiaimSpeed) end
    end)
    jitterBox.FocusLost:Connect(function()
        local v = tonumber(jitterBox.Text)
        if v then antiaimJitterRange = math.abs(v); jitterBox.Text = tostring(antiaimJitterRange) else jitterBox.Text = tostring(antiaimJitterRange) end
    end)
    ...
    RunService.RenderStepped:Connect(function(dt)
        if rageEnabled and selectedPlayer and selectedPlayer.Character and selectedPlayer.Character:FindFirstChild("HumanoidRootPart") then
            ...
            if myChar and myChar:FindFirstChild("HumanoidRootPart") and myChar:FindFirstChild("Humanoid") and myChar.Humanoid.Health > 0 then
                ...
                -- Auto-aim (face target) unless anti-aim modifies orientation
                local desiredLook = (targetHRP.Position - myHRP.Position).Unit
                local desiredCFrame = CFrame.new(myHRP.Position, targetHRP.Position)

                if antiaimEnabled and antiaimMode ~= "Off" then
                    -- update current yaw/pitch based on mode
                    if antiaimMode == "Spin" then
                        antiaimCurrentYaw = (antiaimCurrentYaw + antiaimSpeed * (dt or 0.016)) % 360
                        antiaimCurrentPitch = antiaimPitch
                    elseif antiaimMode == "Jitter" then
                        antiaimCurrentYaw = antiaimYaw + (math.random() * 2 - 1) * antiaimJitterRange
                        antiaimCurrentPitch = antiaimPitch + (math.random() * 2 - 1) * (antiaimJitterRange * 0.5)
                    elseif antiaimMode == "Static" then
                        antiaimCurrentYaw = antiaimYaw
                        antiaimCurrentPitch = antiaimPitch
                    end

                    -- Compute base direction to target
                    local pos = myHRP.Position
                    local targetPos = targetHRP.Position
                    local baseLook = (targetPos - pos).Unit
                    -- Get base yaw and pitch from look direction
                    local baseYaw = math.atan2(baseLook.X, baseLook.Z)
                    local basePitch = math.asin(baseLook.Y)
                    -- Apply offsets
                    local finalYaw = baseYaw + math.rad(antiaimCurrentYaw)
                    local finalPitch = basePitch + math.rad(antiaimCurrentPitch)
                    -- Build new look vector
                    local lookX = math.cos(finalPitch) * math.sin(finalYaw)
                    local lookY = math.sin(finalPitch)
                    local lookZ = math.cos(finalPitch) * math.cos(finalYaw)
                    local newLook = Vector3.new(lookX, lookY, lookZ)
                    myHRP.CFrame = CFrame.lookAt(pos, pos + newLook)
                else
